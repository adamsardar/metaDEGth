...
This workbook assumes that user has already performed read alignment. For 99% of cases, this first stage is best performed using a pseudo-alignment tool such as [Kallisto](https://github.com/pachterlab/kallisto), which uses counts of sub-strings in common between reads and reference gene sequences. See command.log for a summary of the steps.
...
TODO - add gene symbols to output

```{r Gene mapping}


setorder(siTAZdiffex_DT, siTAZdiffex_DT$pVal_GTEabsLFC1.5)

#Write the results out to a data file
