...
siTAZdiffex_HFL1_DT <- siTAZdiffex_DT[,.(ENSG, geneSymbol, accession, name, geneID, siTAZ1_logFC, siTAZ1_pValue, siTAZ2_logFC, siTAZ2_pValue)] # Only save important fields

setorder(siTAZdiffex_HFL1_DT, siTAZ1_pValue )

#Write the results out to a data file for inclusion in the package
save(siTAZdiffex_HFL1_DT, file = "./data/siTAZdiffex_HFL1_DT.RData", compress = "xz")

siTAZdiffex_HFL1_DT[ p.adjust(siTAZ1_pValue,"fdr") < 1E-3][order(-siTAZ1_logFC)]
```
