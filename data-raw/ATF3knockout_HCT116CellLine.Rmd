...
The process used is similar to that 


# Import data

Download the unnormalised zipped expression data directly from GEO, then annotate the columns and background normalise using limma::neqc. I tried downloaded the processed files and the P-value distribution was very odd - I suspect and artifact. 
...
rAAVATF3_diffexDT <- GSE74362_diffexDT
