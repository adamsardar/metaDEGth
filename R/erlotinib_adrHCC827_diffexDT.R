#' Microarray assay to understand acquired drug resistance to EGFR-targeted therapy (erlotinib) in cell lines
#' 
...
#' 
#' @docType data
#' @usage data(erlotinib_adrHCC827_diffexDT)
#' 
...
#' @format A data.table with 48,803 rows, documenting probe-level differential expression in three erlotinib-treated cell lines: HCC827 (susceptible) and against ER3/T15.2 (evolved resistance). Additional gene symbols, entrez gene IDs and uniprot annotations also included.
