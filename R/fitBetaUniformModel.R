...
#' @describeIn fitBetaUniformMixtureDistribution fitting using nStarts defined
...
#' @param a beta distribution shape parameter
#' @param lambda parameter lambda
#' @param log return the logarithmic version of the output
...
#' @param a non-negative parameter of the Beta distribution.
